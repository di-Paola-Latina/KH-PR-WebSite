        ...
        <div class="card mb-3 w-100 border-0">
            <div class="row no-gutters">
                <div class="col-md-6 align-self-center">
                    <img src="../img/pr/prod/<?php echo $productos[$i]['img'];?>" class="card-img w-75 d-block ml-md-auto mr-md-0 mx-auto" alt="...">
                </div>
                <div class="col-md-6 align-self-center">
        ...
        <div class="card mb-3 w-100 border-0">
            <div class="row no-gutters">
                ...
                <div class="col-md-6 align-self-center order-md-2 order-1">
                    <img src="../img/pr/prod/<?php echo $productos[$i]['img'];?>" class="card-img w-75 d-block mr-md-auto ml-md-0 mx-auto " alt="...">
                </div>
            </div>
        </div>
        <div class="w-80 bg-naranja mx-auto my-5" style="height: 1px;"></div>
        ...
        <div class="card mb-3 w-100 bg-light border-0">
            <div class="row no-gutters ">
                ...
                <div class="col-md-6 align-self-center bg-light order-md-2 order-1">
                    <img src="../img/pr/prod/receta_prod_sec.png" class="card-img w-75 d-block mr-auto p-md-4 p-2 mr-md-5 bg-light" alt="...">
                </div>
            </div>
        </div>
    </div>
